<template>
  <div class="fixed inset-0 flex items-center justify-center bg-opacity-50 z-[100]">
    ...
    <div class="p-5 bg-white rounded-md relative z-[101]">
      <div class="bg-gray-50 bg-opacity-50 rounded-md flex flex-col min-w-[600px]">
        <!-- Header -->
        ...
        <div class="p-6">
          ...
          <div v-if="step === 1">
            <h3 class="text-xl font-semibold mb-4 text-gray-800">Admin Information</h3>
            
            <form @submit.prevent="generateToken" class="w-full">
              <div class="flex flex-col space-y-5 py-3 px-10">
                <div class="space-y-4">
                  <div class="flex items-center">
                    <label class="text-sm font-medium text-gray-700 w-24 flex items-center gap-1">
                      Email
          ...
          <div v-if="step === 2" class="text-center py-8">
            <div class="mb-6">
              ...
              <p class="text-gray-600 mb-6">Share this information with the new admin to complete their registration.</p>
            </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <h4 class="text-sm font-semibold text-blue-900 mb-2">Instructions for the new admin:</h4>
              <ol class="text-sm text-blue-800 text-left space-y-1">
                ...
                <li>4. They can then login to the system as an admin</li>
              </ol>
            </div>
  ...
  methods: {
    async generateToken() {
      ...
      try {
        ...
        console.log('Sending admin token request:', payload);
